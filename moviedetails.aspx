...
<body>
    ...
    <div>
        ...
        <br />
        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" DataKeyNames="MovieID" DataSourceID="SqlDataSource1" Height="50px" Width="125px" CellPadding="4" CellSpacing="2">
            <Fields>
